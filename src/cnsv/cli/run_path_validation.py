...
def main() -> int:
    ...
    write_path_distribution_json(distribution, root / "docs/data/latest_path_distribution_report.json")
    write_path_validation_json(validation, root / "docs/data/latest_path_validation_report.json")
    ...
    quality = validation["path_validation_quality"]
    print(f"path_validation_quality={quality['status']} failed={quality['failed_count']} warn={quality['warn_count']}")
