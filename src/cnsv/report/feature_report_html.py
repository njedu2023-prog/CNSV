...
<main>
  ...
  <section><h2>趋势摘要</h2><div id="trend" class="grid"></div></section>
  <section><h2>波动率摘要</h2><div id="volatility" class="grid"></div></section>
</main>
<script>
...
const signedChip = (label, value) => `<span class="chip ${signedTone(value)}">${label}：${fmt(value)}</span>`;
