...
<main>
  <header>
    <p class="eyebrow">CNSV V1.2 主线看板</p>
    <h1>中国船舶主线看板</h1>
    <p class="subtitle">展示 CNSVdata 准入、数据覆盖、特征质量、核心特征与 V1.2 基准模型入口。页面不生成交易动作。</p>
    <nav><a href="#coverage">数据状态</a><a href="#priceVolumeCards">核心特征</a><a href="baseline.html">V1.2 基准模型看板</a></nav>
  </header>
