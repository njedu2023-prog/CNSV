  ...
  <div class="hero">
    <div>
      ...
      <div class="decision">
        ...
        <table class="timeline-table pair-table" aria-label="收盘数据表"><tbody>
...
function render(payload) {
  ...
  document.getElementById("footer").textContent = `生成时间（北京时间）：${formatBeijing(payload.generated_at_beijing || payload.generated_at)} · 数据交易日：${payload.trade_date || "N/A"} · 每日 20:04 自动更新，页面每 5 分钟检查`;
}
