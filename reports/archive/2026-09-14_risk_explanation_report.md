...
- B2_state_sample_risk: medium；B2 最小状态样本数为 100。
...
- touch_down_risk: medium；20D touch_down_5pct_prob=0.5455。
- max_drawdown_risk: medium；20D max_drawdown_p50=-0.0733。
...
- p2_state_sample_risk: medium；P2 min_state_sample_size=100。
...
## 风险情景卡片
- [downside_touch_risk_card] 下穿路径风险: medium；下穿概率升高时，风险解释层要求人工复核路径尾部。
