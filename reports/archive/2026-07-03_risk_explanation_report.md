...
## 特征风险解释
- risk_level: low
- trend_state_risk: low；趋势状态为 neutral，需要结合路径风险复核。
...
- B2_state_sample_risk: medium；B2 最小状态样本数为 32。
...
- touch_down_risk: high；20D touch_down_5pct_prob=0.6365。
- max_drawdown_risk: medium；20D max_drawdown_p50=-0.0948。
...
- p2_state_sample_risk: medium；P2 min_state_sample_size=32。
