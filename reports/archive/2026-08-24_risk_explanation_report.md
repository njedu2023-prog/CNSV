...
- B2_state_sample_risk: medium；B2 最小状态样本数为 188。
...
- touch_down_risk: low；20D touch_down_5pct_prob=0.3133。
...
- p2_state_sample_risk: medium；P2 min_state_sample_size=188。
...
- risk_evidence: 20D P1 相对 P0 表现偏弱。, P2 fallback_rate 偏高，P2 只能作为辅助观察。, path_quality 状态为 WARN，需要降级复核。
