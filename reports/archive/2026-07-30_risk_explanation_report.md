...
- B2_state_sample_risk: high；B2 最小状态样本数为 23。
...
- touch_down_risk: high；20D touch_down_5pct_prob=0.6388。
- max_drawdown_risk: medium；20D max_drawdown_p50=-0.0957。
...
- p2_state_sample_risk: high；P2 min_state_sample_size=23。
