...
- B2_state_sample_risk: medium；B2 最小状态样本数为 91。
...
- touch_down_risk: high；20D touch_down_5pct_prob=0.6572。
- max_drawdown_risk: medium；20D max_drawdown_p50=-0.1015。
...
- p2_state_sample_risk: medium；P2 min_state_sample_size=91。
