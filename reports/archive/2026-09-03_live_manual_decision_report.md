...
- touch_down_summary: {'5D': {'touch_down_5pct_prob': 0.08101851851851852}, '10D': {'touch_down_5pct_prob': 0.17048673705897502}, '20D': {'touch_down_5pct_prob': 0.3126775109734056}}
- drawdown_summary: {'5D': {'max_drawdown_p50': -0.015466465410946983, 'max_drawdown_p90': -0.00441716298436936}, '10D': {'max_drawdown_p50': -0.0280839895013123, 'max_drawdown_p90': -0.010927584052044125}, '20D': {'max_drawdown_p50': -0.044064171122994655, 'max_drawdown_p90': -0.02055957075146754}}

## 风险解释摘要
- overall_risk_level: high
- primary_risk_sources: data_risk, feature_risk, p2_auxiliary_risk, evidence_conflict_risk
- secondary_risk_sources: baseline_model_risk, path_distribution_risk, path_validation_risk, observation_backtest_risk, decision_support_risk, system_boundary_risk

## 证据冲突摘要
- evidence_conflict: True
- conflict_reasons: 20D P1 相对 P0 表现偏弱。, P2 fallback_rate 偏高，P2 只能作为辅助观察。, data_quality 状态为 WARN，需要降级复核。, feature_quality 状态为 WARN，需要降级复核。, path_quality 状态为 WARN，需要降级复核。
...
## 人工确认区
- decision_session_id: manual-2026-09-03-20260903144340
- decision_snapshot_id: live-2026-09-03-9reports
