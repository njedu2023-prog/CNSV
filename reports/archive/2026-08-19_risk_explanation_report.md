...
- B2_state_sample_risk: medium；B2 最小状态样本数为 224。
...
- touch_down_risk: low；20D touch_down_5pct_prob=0.3496。
- max_drawdown_risk: low；20D max_drawdown_p50=-0.0472。
...
- p2_state_sample_risk: medium；P2 min_state_sample_size=224。
